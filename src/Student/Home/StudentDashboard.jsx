  ...
  return (
    <div className="grid grid-cols-[256px_1fr] min-h-screen">
      ...
      <div className="main-content bg-white text-teal md:px-20 lg:px-28 pt-8 md:pt-12">
        ...
        {/* Content Wrapper */}
        <div className="flex flex-col bg-gray-200 rounded-2xl p-8 min-h-[calc(100vh-8rem)]">
          {/* Join Class Button */}
          <button
            onClick={handleJoinClassClick}
            className="ml-auto w-1/6 h-1/4 bg-teal text-white rounded-lg p-4 text-sm hover:bg-peach"
          >
            Join Class
          </button>
