...
const DeveloperCard = ({ name, image }) => {
  return (
    <div className="relative group">
      ...
      >
        <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-300">
    ...
    <div className="w-full py-10">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-semibold mb-6 text-gray-900">
          About Us <span role="img" aria-label="developer">👩‍💻</span>
        </h2>
